...
public interface StoreImgRepository extends JpaRepository<StoreimageEntity,Integer> {
    @Query("select new cn.tju.sse.spring_backend.dto.accountInfoSys.getinformation.StoreImgResponseDTO(q.stoImage) from StoreimageEntity q where q.stoId=:sto_ID")
